...
class RegisterController extends Controller
{
    ...
    public function store(){
        ...
        return redirect('login'); // todo: use named routes in your app : https://laravel.com/docs/10.x/controllers#main-content:~:text=return%20Redirect%3A%3Aroute(%27photos.index%27)
    }
}
